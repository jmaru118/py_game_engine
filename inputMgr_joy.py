...
# ---------------------
    ...
    def checkCollisionP1(self):
        for Entity in self.entites:
            if (self.entites[Entity].uiname is not self.player1.uiname) and (self.entites[Entity].type is not "bullet"):
    ...
    def checkCollisionP2(self):
        for Entity in self.entites:
            if (self.entites[Entity].uiname is not self.player2.uiname) and (self.entites[Entity].type is not "bullet"):
